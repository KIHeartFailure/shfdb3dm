...
source("./munge/05-selection_swedehf.R")
source("./munge/06-controls_scb.R")
source("./munge/07-countryofbirth_scb.R")
source("./munge/08-lisa_scb.R")
...
# run 09
source("./munge/09-prep_sosdata.R")
...
source("./munge/11-outcom_sos.R")
source("./munge/12-charlsoncomorbindex_sos.R")
source("./munge/13-death_sos.R")
source("./munge/14-niceties.R")
source("./munge/15-save.R")
