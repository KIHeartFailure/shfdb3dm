...
rsdata <- create_sosvar(
  ...
  type = "com",
  name = "cci_chf",
  diakod = " 425[E-H]| 425W| 425X| 428| 1099| 1110| 1130| 1132| I255| I420| I425| I426| I427| I428| I429| I43| I50| P290",
  valsclass = "num", 
  warnings = FALSE
)
...
rsdata <- create_sosvar(
  ...
  type = "com",
  name = "cci_diabetes",
  diakod = " 250[A-C]| 250H| 250X| E100| E101| E106| E108| E109| E110| E111| E116| E118| E119| E120| E121| E126| E128| E129| E130| E131| E136| E138| E139| E140| E141| E146| E148| E14.9",
  valsclass = "num", 
  warnings = FALSE
)
...
rsdata <- create_sosvar(
  ...
  type = "com",
  name = "cci_plegia",
  diakod = " 334B| 342Z| 343| 344[A-G]| 344X| G041| G114| G801| G802| G81| G82| G83[0-4]| G839",
  valsclass = "num", 
  warnings = FALSE
)
...
rsdata <- create_sosvar(
  ...
  type = "com",
  name = "cci_renal",
  diakod = " 403A| 403B| 403X| 404A| 404B| 404X| 582| 583[A-C]| 583E| 583G| 583H| 585| 586| 588W| V42A| V45B| V56| 1120| I1131| N03[2-7]| N05[2-7]| N18| N19| N250| Z49[0-2]| Z940| Z992",
  valsclass = "num", 
  warnings = FALSE
)
...
rsdata <- create_sosvar(
  ...
  diakod = " 456[A-C]| 572[C-E]| 572W| 1850| I1859| I1864| I1982| K704| K711| K721| K729| K765| K766| K767",
  valsclass = "num", 
  warnings = FALSE
)
...
rsdata <- rsdata %>%
  mutate(
    sos_com_cci_diabeteschronic = sos_com_cci_diabeteschronic * 2, 
  ...
  mutate(sos_charlsonci = rowSums(select(., starts_with("sos_com_cci_")))) %>%
